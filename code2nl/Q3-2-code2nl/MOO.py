...
def dominates(candidate1, candidate2):
    ...
    dominates = False
    # if (candidate1_objectives[0] > candidate2_objectives[0]) and (candidate1_objectives[1] > candidate2_objectives[1]) and (candidate1_objectives[2] > candidate2_objectives[2]) and( candidate1_objectives[3] > candidate2_objectives[3]):
    # if (candidate1_objectives[0] > candidate2_objectives[0]) and (candidate1_objectives[3] > candidate2_objectives[3]):
    if candidate1_objectives[0] > candidate2_objectives[0] :
        dominates = True
    return dominates
...
if __name__ == "__main__":
    ...
    # map_functionList=[[7,8,9,10,11,12]]
    logging.info("Current map_functionList: {}".format(map_functionList))
    
    bleus,ppls = distill(tokenizer,args,map_functionList, eval=False,surrogate=False)
