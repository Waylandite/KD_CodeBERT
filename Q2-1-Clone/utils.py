...
class TextDataset(Dataset):
    def __init__(self, tokenizer, args, evaluate,test,file_path=None):
        self.examples = []
...
def load_and_cache_examples(args, tokenizer, evaluate=False, test=False):
    dataset = TextDataset(tokenizer, args,evaluate,test,file_path=args.test_data_file if test else (
