...
def main():
    ...
    config = RobertaConfig.from_pretrained('/home/wuruifeng/data/models/4layer_config')
    config.num_labels = 2
    # print(config)
    # exit()
    ...
    # model = Model(RobertaForSequenceClassification.from_pretrained('/data/wuruifeng/models/codebert-base', config=config))
    # model = Model(RobertaForSequenceClassification.from_pretrained('/data/wuruifeng/result/Vulnerability-Detection/Finetune/finetune', config=config))
