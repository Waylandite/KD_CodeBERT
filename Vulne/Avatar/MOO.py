...
from utils import old_hyperparams_convert
...
if __name__ == "__main__":
    ...
    lb = [1, 1000, 1, 16, 1, 0.1, 32, 1, 0.1, 256, 1, 1, 1]
    ...
    accs, f1s, pres, recs = distill(args,surrogate_data, surrogate=True)
    ...
    with open("surrogate_train_data.csv", "w") as f:
        ...
        for d, acc in zip(surrogate_data, accs):
            writer.writerow(old_hyperparams_convert(d) + [acc])
