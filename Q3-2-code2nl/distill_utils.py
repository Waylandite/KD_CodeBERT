...
def distill(args, hyperparametersList, eval=False, surrogate=False):
    ...
    for hyperparam in hyperparametersList:
        ...
        config.num_hidden_layers = int(hyperparam['hidden_layers'])
        ...
        dev_best_outcomes = train(student_model, teacher_model, map_function, train_dataloader, eval_dataloader,
                                  bleu_eval_dataloader, bleu_eval_examples,
                                  int(hyperparam["hid_epoches"]),
                                  args.pred_epoches, hyperparam["learning_rate"], args.pred_learning_rate, args.temperature,
                                  args.device, hyperparam["loss_function"], args.eval_steps, tokenizer, surrogate)
